package com.bruno.monthlydeposits
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_screen_montly_deposit.setOnClickListener {
            val intent = Intent(this, ScreenMonthlyDepositActivity::class.java)
        ...
        btn_screen_montly_deposit_with_init_deposit.setOnClickListener {
            val intent = Intent(this, ScreenWithInitialDepositActivity::class.java)
            startActivity(intent)
        }
